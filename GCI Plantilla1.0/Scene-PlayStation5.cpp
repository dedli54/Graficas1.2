...
bool Scene::Initialize() {
	...
	//Terreno = new Land(handlerWindow, OpenGL, LoaderTexture, L"recursos/heightmap.jpg", "recursos/test.tga", "recursos/Piedras_normal.jpg", "recursos/heightmap.jpg",(float)400, (float)400);
	Terreno = new Land(handlerWindow, OpenGL, LoaderTexture, L"textures/heightmap.jpg", "textures/terrain1.jpg", "textures/terrain2.jpg", "recursos/heightmap.jpg", (float)400, (float)400);
	if (!Terreno){
		result = false;
