...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR pScmdline, int iCmdshow)
{
	...
	m_applicationName = L"Si se pasa";
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT umessage, WPARAM wparam, LPARAM lparam)
{
	...
	case WM_CLOSE:
	{
		...
		if (MessageBox(hwnd, L"Quieres cerrar el juego?", L"Confirmation", MB_YESNO | MB_ICONQUESTION) == IDYES)
		{
			// If the user clicks "Yes", hide the window or perform other cleanup
